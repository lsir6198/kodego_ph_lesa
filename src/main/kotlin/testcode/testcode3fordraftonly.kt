...
fun main(){
    ...
    var toDoList = mapOf(1 to "1. VIEW GROCERY LIST", 2 to "2. ADD TO CART", 3 to "3. CHECKOUT", 4 to "4. REMOVE FROM THE CART")
...
class grocerySystem {
    ...
    fun addToCart() {
        ...
        println("Add to Cart:")
        cart.put("cheese_01",1)
        cart.put("garlic_02",2)
        cart.put("onion_03",3)
